...
begin
  ...
  begin
    ...
    Add('      <img src="font/star.gif" width="20" height="20"><button class="js-star-board" title="Click to star board. It will show at top of your board list." aria-label="Click to star board. It will show at top of your board list.">Star</button>');
    Add('      <img src="font/arrow/white/duplicate.gif" width="20" height="20"><button class="js-clone-board" title="Duplicate board" aria-label="Duplicate board">Duplicate</button>');
    Add('      <img src="font/arrow/white/archive.gif" width="20" height="20"><button class="js-archive-board" title="Move to Archive" aria-label="Move to Archive">Move to Archive</button>');
