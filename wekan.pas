...
begin
  ...
  begin
    ...
    Add('        <img src="images/logo-header.png" alt="WeKan ®" title="WeKan ®">&nbsp;&nbsp;&nbsp;<img src="font/arrow/white/home.gif" width="20" height="auto">&nbsp;');
    ...
    Add('  </tr>');
    Add('  <tr>');
    Add('    <td colspan="8" bgcolor="#2980b9"><font size="5" color="#FFFFFF" face="arial"><b>My Boards</b></font><br>');
    Add('      <button title="Add Board" href="#" aria-label="Add Board">Add Board</button>&nbsp;&nbsp;&nbsp;');
    Add('      <font size="3" color="#FFFFFF" face="arial">Selected:</font>');
    Add('      <img src="font/star.gif" width="20" height="auto"><button class="js-star-board" title="Click to star board. It will show at top of your board list." aria-label="Click to star board. It will show at top of your board list.">Star</button>');
    Add('      <img src="font/arrow/white/duplicate.gif" width="20" height="auto"><button class="js-clone-board" title="Duplicate board" aria-label="Duplicate board">Duplicate</button>');
    Add('      <img src="font/arrow/white/archive.gif" width="20" height="auto"><button class="js-archive-board" title="Move to Archive" aria-label="Move to Archive">Move to Archive</button>');
    Add('      <font size="3" color="#FFFFFF" face="arial">Orgs | Teams</font>');
    Add('    </td>');
    Add('  </tr>');
    Add('</table>');
    Add('<font face="arial">');
    ...
    Add('        <a href="/b/{%= starboard._id%}/{%= starboard.slug%}">');
    ...
    Add('      <div class="card" draggable="true">');
    Add('        <a href="/b/{%= nostarboard._id%}/{%= nostarboard.slug%}">');
    ...
    Add('      <div class="card" draggable="true">');
    Add('        <a href="/b/{%= templateboard._id%}/{%= templateboard.slug%}">');
